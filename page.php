		...
		<table align="center" id="posted" width="1130">
			...
			<?php
				...
				while($data=mysql_fetch_array($query)){echo
					'<tr>
						<td height="50"><p align="center"><a href="page.php?title='.$data['title'].'&index='.$data['id'].'"><img id="page" src="data:image/jpeg;base64,'.base64_encode( $data['image'] ).'"/></a></td>
				...
				while($data=mysql_fetch_array($query)){echo
					'<tr>
						<td height="50"><a href="page.php?title='.$data['title'].'&index='.$data['id'].'"><img id="page" src="data:image/jpeg;base64,'.base64_encode( $data['image'] ).'"/></a></td>
						<td width="220"><a id="page" href="page.php?title='.$data['title'].'&index='.$data['id'].'">'.substr($data['title'],0,60).' ...</a></td>
					</tr>';
					$x+=1;
				}

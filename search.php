			...
			<tr align="left">
				<td width="376"><p align="center">
					<?php
						...
						$query_total=mysql_query("select * from posted where title like '%".$_GET['searching']."%'");
						
						while($data=mysql_fetch_array($query_total)){
							$y+=1;
						}

						$query=mysql_query("select * from posted where title like '%".$_GET['searching']."%' order by postdate desc limit ".$x.",1");
